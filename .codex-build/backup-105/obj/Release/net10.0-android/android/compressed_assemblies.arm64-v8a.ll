...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [135 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 15691728; uint32_t buffer_offset
	}, ; 132: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22368, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 15862736; uint32_t buffer_offset
	}, ; 133: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2066432, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 15885104; uint32_t buffer_offset
	} ; 134: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 17951536, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [17951536 x i8] zeroinitializer, align 1
