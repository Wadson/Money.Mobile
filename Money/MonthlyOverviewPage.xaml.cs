...
public partial class MonthlyOverviewPage : ContentPage
{
    ...
    private async Task LoadAsync()
    {
        ...
        RemainingLabel.TextColor = ThemeColor.Get(data.Remaining >= 0 ? "BlingTextLight" : "BlingText");
        ...
        MarginStatusLabel.TextColor = ThemeColor.Get(
            data.Commitment < 70 ? "BlingPrimary" : data.Commitment <= 90 ? "BlingText" : "BlingText");
