...
public partial class ReportPage : ContentPage
{
    ...
    private async void OnGenerateClicked(object? sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ResultLabel.Text = $"{_result.ItemCount} lançamento(s)\n" +
                               $"Receitas: {_result.Income.ToString("C2", _culture)}\n" +
                               $"Despesas: {_result.Expenses.ToString("C2", _culture)}\n" +
                               $"Saldo: {_result.Balance.ToString("C2", _culture)}";
    ...
    private async void OnSaveClicked(object? sender, EventArgs e)
    {
        ...
        catch (Exception ex) { await ThemedDialog.ShowAsync(this, "Não foi possível salvar", ex.Message); }
    }
    ...
    private async void OnShareClicked(object? sender, EventArgs e)
    {
        ...
        catch (Exception ex) { await ThemedDialog.ShowAsync(this, "Não foi possível compartilhar", ex.Message); }
    }
